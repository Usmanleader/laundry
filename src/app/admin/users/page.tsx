          ...
          <Card>
            <CardContent className="p-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-sm text-slate-600">With Orders</p>
                ...
                <table className="w-full">
                  <thead>
                    <tr className="border-b text-left">
                      <th className="py-3 px-4 text-sm font-medium text-slate-500">User</th>
                      <th className="py-3 px-4 text-sm font-medium text-slate-500">Contact</th>
                      <th className="py-3 px-4 text-sm font-medium text-slate-500">Role</th>
                      <th className="py-3 px-4 text-sm font-medium text-slate-500">Orders</th>
                      <th className="py-3 px-4 text-sm font-medium text-slate-500">Total Spent</th>
                      <th className="py-3 px-4 text-sm font-medium text-slate-500">Joined</th>
                    </tr>
                  </thead>
                  <tbody>
                      ...
                      <tr key={user.id} className="border-b hover:bg-slate-50">
                        <td className="py-3 px-4">
                          <div className="flex items-center gap-3">
                            <div className="flex h-10 w-10 items-center justify-center rounded-full bg-sky-50 text-sky-500 font-semibold">
                        ...
                        <td className="py-3 px-4">
                          {user.phone ? (
                            <a href={`tel:${user.phone}`} className="flex items-center gap-1 text-slate-600 hover:text-sky-500">
