          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-4">
                <Link href="/admin/orders?status=pending" className="flex items-center justify-between p-3 rounded-lg hover:bg-gray-50 transition-colors">
                ...
                <Link href="/admin/orders?status=picked_up" className="flex items-center justify-between p-3 rounded-lg hover:bg-gray-50 transition-colors">
                  <div className="flex items-center gap-3">
                ...
                <Link href="/admin/orders?status=washing" className="flex items-center justify-between p-3 rounded-lg hover:bg-gray-50 transition-colors">
                  <div className="flex items-center gap-3">
                ...
                <Link href="/admin/orders?status=out_for_delivery" className="flex items-center justify-between p-3 rounded-lg hover:bg-gray-50 transition-colors">
                  <div className="flex items-center gap-3">
                ...
                <Link href="/admin/orders?status=delivered" className="flex items-center justify-between p-3 rounded-lg hover:bg-gray-50 transition-colors">
                  <div className="flex items-center gap-3">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between p-4 rounded-lg bg-blue-50">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-blue-700">{todayOrders || 0}</p>
                  </div>
